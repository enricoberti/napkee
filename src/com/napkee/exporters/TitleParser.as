package com.napkee.exporters
{
	...
	public class TitleParser extends BasicParser implements IControlParser
	{
		
		public function TitleParser(controlCode:XML,offsetModifier:OffsetModifier)
		{
			super(controlCode,offsetModifier);
            templateName = "title.xml";
			if (StringUtils.isBlank(control.controlProperties.text)){
				control.controlProperties.text = "A%20Big%20Title";
			}
		}
		...
		public override function getCss():String
		{
			...
			if (StringUtils.isNotBlank(control.controlProperties.size)){
				...
				cp.setPlaceHolder("fontSize","40px");
			}
